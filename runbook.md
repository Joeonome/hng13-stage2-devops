...
### 1️⃣ Overview
This runbook provides step-by-step instructions for deploying, monitoring, and troubleshooting the **Blue/Green Node.js service** behind **Nginx** with automatic failover, manual toggle, and Slack-based alerts.
...
```bash
docker exec -it nginx_gateway cat /var/log/nginx/access.log
```
